...
import org.symphonyoss.integration.webhook.zapier.parser.BaseZapierParserFactory;
 ...
 */
@Component
public class V1ZapierParserFactory extends BaseZapierParserFactory {

  @Autowired
  public V1ZapierParserFactory(ZapierPostMessageParser parser) {
    super(parser);
  }
