...
/**
 * Unit test for {@link V1ZapierParserFactory}
 * Created by rsanchez on 05/04/17.
 */
@RunWith(MockitoJUnitRunner.class)
public class V1ZapierParserFactoryTest {

  @Mock
  private ZapierNullParser defaultParser;

  private ZapierPostMessageParser postMessageParser = new ZapierPostMessageParser();

  private V1ZapierParserFactory parserFactory;

  @Before
  public void init() {
    this.parserFactory = new V1ZapierParserFactory(postMessageParser);
  ...
  public void testAccept() {
    ...
    assertFalse(parserFactory.accept(MessageMLVersion.V2));
  }
